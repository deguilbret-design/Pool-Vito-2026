...
st.markdown('.ticker { display: flex; width: max-content; animation: tk 15s linear infinite; }', unsafe_allow_html=True)
...
if 'Nom' in df_part.columns:
    ...
    with st.expander("📜 Règlement"):
        ...
        st.markdown('<div class="rules-section"><div class="rules-title">🎯 2. Bonus de Précision</div>', unsafe_allow_html=True)
        ...
        st.markdown('<p style="font-size:0.8rem;color:#64748b;margin-top:10px;">*Exception Match 7 : Accordé même si ton équipe perd.</p></div>', unsafe_allow_html=True)

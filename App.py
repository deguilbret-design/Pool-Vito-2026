...
.ticker { display: inline-flex; width: max-content; animation: tk 15s linear infinite; }
...
.live-dot { height: 6px; width: 6px; background: #ff4b4b; border-radius: 50%; display: inline-block; margin-right: 5px; animation: blk 1s infinite; }
...
.rules-section { background: #f8fafc; padding: 15px; border-left: 4px solid #1f77b4; margin-bottom: 15px; border-radius: 4px; font-size: 0.95rem; }
...
if 'Nom' in df_p.columns:
    ...
    with st.expander("📜 Règlement Officiel"):
        st.markdown("""<div class="rules-section">
            ...
            • <b>Format :</b> Éliminatoire (1/8, 1/4, 1/2 et Finale).<br>
            • <b>Choix Initiaux :</b> Gagnant de la Coupe Stanley et Joueur MVP (Conn Smy
